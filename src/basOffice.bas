...
Public Function GetExcelWkbOpenAsObject(strPath As String) As Object
          ' Get reference to Microsoft Excel application object
            ...
            If Not fFileOpen Then
                ' Open document
                Set wkb = objApplication.Workbooks.Open(FileName:=strPath)
            End If
...
Public Function GetOfficeApplication(ByRef oatOfficeApplictionType As oatcOfficeApplictionType, Optional ByRef fOfficeApplicationOpen As Boolean) As Object
...
Dim strClass As String
    ...
    ' Get instance of Microsoft Office Application Object (Application already open)
