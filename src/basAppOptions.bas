...
On Error Resume Next
    ...
    'Don't allow enable Cacel Key for this applicatoin
...
Public Sub ToolHideSheet(sht As Worksheet)
    sht.Visible = xlSheetVeryHidden
End Sub

Public Sub ToolRestoreSheet(sht As Worksheet)
    sht.Visible = xlSheetVisible
End Sub

Public Sub ToolRestoreAllSheets()
